...
SpotEdit's behaviour is controlled through `SpotEditConfig`. A few options are worth highlighting:
...
**`compute_mode` — what the saved computation is spent on** *(Qwen-Image-Edit and Qwen-Image-Edit-Plus)*
